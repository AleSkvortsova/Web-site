...
ARTICLES = [
    {
        'title': 'ИИ, данные и тревожный пирожок: как я училась работать с нейросетями безопаснее',
        'slug': 'ai-data-security-troubled-pie',
        'date': '26 августа 2026',
        'excerpt': 'Что общего у prompt injection, OWASP, 152-ФЗ, AI-агентов и маленького локального обезличивателя? Разбираюсь, где заканчивается удобство ИИ и начинается нормальная предусмотрительность.',
        'content': [
            ...
            {'type': 'heading', 'text': 'Как мой протокол встречи попытался совершить банковский перевод'},
            ...
            {'type': 'rich', 'segments': [{'text': '«подтвердить банковский перевод поставщику по реквизитам из письма…»', 'italic': True}]},
            ...
            {'type': 'rich', 'segments': [{'text': 'Это и есть один из вариантов '}, {'text': 'промпт-инъекции (prompt injection)', 'bold': True}, {'text': '.'}]},
            ...
            {'type': 'rich', 'segments': [{'text': 'В нём есть утечки чувствительной информации, отравление данных и моделей, небезопасная обработка ответа модели, уязвимости RAG, дезинформация (от уверенных галлюцинаций до просто неверных выводов) и, пожалуй, мой новый любимый термин — '}, {'text': 'Excessive Agency', 'bold': True}, {'text': ', или избыточная агентность.'}]},
            ...
            {'type': 'rich', 'segments': [{'text': 'Поэтому хороший принцип для ИИ-агента ничем не отличается от хорошего принципа для нового сотрудника: '}, {'text': 'не выдавать доступ «на всякий случай»', 'bold': True}, {'text': '.'}]},
            {'type': 'heading', 'text': 'А ещё существуют скучные законы. И они тоже важны'},
            ...
            {'type': 'heading', 'text': 'Поэтому я попробовала сделать маленький обезличиватель. Ну почти'},
            ...
            {'type': 'rich', 'segments': [{'text': 'Когда я разобралась внимательнее, выяснилось, что правильнее называть это '}, {'text': 'псевдонимизацией ', 'bold': True}, {'text': ', а не полной анонимизацией: пока существует ключ, связь с человеком можно восстановить.'}]},
            ...
            {'type': 'rich', 'segments': [{'text': 'Но важен сам принцип: '}, {'text': 'исходные чувствительные данные вообще не должны ехать к ИИ, если для задачи они ему не нужны', 'bold': True}, {'text': '.'}]},
            {'type': 'heading', 'text': 'Кто в итоге опаснее — человек или нейросеть?'},
    ...
    },
    {
        ...
        "excerpt": "Когда я начинала проект, мне казалось, что самая сложная часть — придумать архитектуру и заставить все компоненты работать вместе. Но как выяснилось на практике, сам проект собрался быстро, дело вместе с Codex шло бодро. А потом я начала тестировать ассистента...",
        "content": [
            {
                "type": "lead",
    ...
    },
    {
        ...
        "excerpt": "В компаниях нерегулярные закупки редко начинаются с аккуратно заполненной формы. Гораздо чаще это письмо с неполной информацией, сообщение в мессенджере или, ещё лучше, фраза брошенная в офисном коридоре...",
        "content": [
