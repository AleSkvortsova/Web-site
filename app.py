...
PROJECTS = [
    ...
    },
    {
        ...
        "summary": "Telegram-ассистент, который превращает свободное описание потребности в структурированную заявку и отвечает на вопросы по внутренней базе знаний.",
...
ARTICLES = [
    {
        ...
        "content": [
            {
                "type": "lead",
                "text": "В процессе работы над ИИ-ассистентом для приёма заявок на закупку, который я делала в качестве выпускной работы на курсах по промпт-инжинирингу (подробнее тут), я на собственном опыте выяснила: сделать почти готовый MVP оказалось в несколько раз быстрее, чем сделать его действительно работающим. И слово «почти» здесь оказалось самым дорогим.",
                "link_text": "тут",
